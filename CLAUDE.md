...
- [ ] 베타 사용자 5명 모집 — 현재 1명 확정, 1명 보류, 3명 모집 중
  - ✅ 1명 확정 (카카오톡 appint12, 62회 응시 예정) — 2026-06-18 온보딩 예정
  - ⏳ 1명 보류 (dorai79, 8월 22일 62회 응시 예정) — 답장 대기 중
- [ ] 1인당 온보딩 — 앱 링크 + 사용 방법 안내, 데이터 수집 설명, 솔직한 피드백 요청
- [ ] 5명 전원 1:1 카카오톡 채널 개설 (지속적 피드백 루프)
- [ ] 매주 평균 3시간 이상 사용 유도 (합격보다 지속 사용이 1차 목표, 30일 기준)
