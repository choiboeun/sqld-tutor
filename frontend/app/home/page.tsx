          ...
          <div className="bg-white w-full max-w-sm mx-4 overflow-hidden shadow-xl">
            ...
            <div className="px-6 py-5 space-y-4">
              ...
              <label className="block">
                <span className="text-xs font-semibold text-stone-400 uppercase tracking-wide mb-1.5 block">시험일 선택</span>
                <div className="relative">
                  <input
                    ...
                    className="w-full border border-stone-300 bg-white text-stone-800 px-3 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 appearance-none"
                    style={{ colorScheme: "light" }}
                  />
                  {!examDateInput && (
                    <span className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-sm text-stone-400 flex items-center gap-1.5">
            ...
            <>
              ...
              <div className="w-full">
                ...
                <div className="relative mb-1" style={{ height: "34px" }}>
                  <span style={{ position: "absolute", left: 0, bottom: 0, fontSize: "11px", fontWeight: 600, color: "rgba(55,48,163,.5)" }}>0점</span>
                  {/* 목표 레이블: 7번째 도트 중심 = (targetScore - 5)% */}
                  <div style={{
                    position: "absolute",
                    left: `${targetScore - 5}%`,
                    ...
                    <span style={{ fontSize: "11px", fontWeight: 700, color: "rgba(55,48,163,.6)", whiteSpace: "nowrap", lineHeight: 1.3 }}>목표 {targetScore}점</span>
                    <span style={{ fontSize: "12px", color: "rgba(55,48,163,.55)", lineHeight: 1 }}>↓</span>
                  </div>
                  <span style={{ position: "absolute", right: 0, bottom: 0, fontSize: "11px", fontWeight: 600, color: "rgba(55,48,163,.5)" }}>100점</span>
                </div>
