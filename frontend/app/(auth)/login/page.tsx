  ...
  return (
    <>
      ...
      <div className="login-page" style={{ display: "flex", width: "100%", minHeight: "100vh", overflow: "hidden" }}>
        ...
        {/* RIGHT */}
        <div ref={rightElRef} className="login-right" style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "52px 48px", position: "relative", overflow: "hidden", background: "#dde1fb" }}>
