    ...
    <div className="lp-root">
      ...
      <div className="wrap">
        ...
        <div className="feat-grid">
          <div className="feat-card"><div className="feat-big">680<span>문제</span></div><p className="feat-t">방대한 문제은행</p><p className="feat-d">SQLD 합격자가 기출 경향을 분석해 직접 제작한 680문제. 11개 카테고리를 고르게 커버해요.</p></div>
